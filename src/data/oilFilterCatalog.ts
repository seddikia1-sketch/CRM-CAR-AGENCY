...
export const OIL_FILTER_CATALOG: OilFilterSpec[] = [
  ...
  s({
    id: 'geely-emgrand', brand: 'Geely', model: 'Emgrand', years: '2015-2026', engine: '1.5 / 1.8 / 1.4T', region: 'chinese',
    oilViscosity: '5W-30 أو 0W-20', oilSpec: 'API SP · SN', oilCapacityL: '3.5 – 4.0',
    oilFilter: 'OEM Geely · Mann W 67/1', airFilter: 'OEM Geely', fuelFilter: 'مدمج أو خارجي', cabinFilter: 'OEM · كربوني',
    notes: 'جيلي إيمقراند — سيدان شائعة',
  }),
  s({
    id: 'geely-binyue-coolray', brand: 'Geely', model: 'Binyue / Coolray', years: '2018-2026', engine: '1.5T', region: 'chinese',
    oilViscosity: '0W-20 أو 5W-30', oilSpec: 'API SP · ACEA C5', oilCapacityL: '3.5 – 4.0',
    oilFilter: 'OEM Geely · Mann', airFilter: 'OEM', fuelFilter: 'مدمج غالباً', cabinFilter: 'OEM · كربوني',
    notes: 'بينوي / كولراي — نفس المنصة تقريباً',
  }),
  s({
    id: 'geely-boyue', brand: 'Geely', model: 'Boyue / Atlas', years: '2016-2026', engine: '1.8T / 1.5T / 2.0', region: 'chinese',
    oilViscosity: '5W-30', oilSpec: 'API SP · ACEA C3', oilCapacityL: '4.0 – 4.5',
    oilFilter: 'OEM Geely · Mann', airFilter: 'OEM', fuelFilter: 'حسب المحرك', cabinFilter: 'OEM',
    notes: 'جيلي بوي / أطلس',
  }),
  s({
    id: 'geely-starry', brand: 'Geely', model: 'Starry', years: '2021-2026', engine: '1.5T / 1.8T', region: 'chinese',
    oilViscosity: '0W-20 أو 5W-30', oilSpec: 'API SP · ACEA C5 / C3', oilCapacityL: '4.0 – 4.5',
    oilFilter: 'OEM Geely · Mann', airFilter: 'OEM', fuelFilter: 'مدمج', cabinFilter: 'OEM · كربوني',
    notes: 'جيلي ستاري / Starry',
  }),
  s({
    id: 'geely-monjaro', brand: 'Geely', model: 'Monjaro / Xingyue L', years: '2021-2026', engine: '2.0T', region: 'chinese',
    oilViscosity: '0W-20 أو 5W-30', oilSpec: 'API SP · ACEA C5', oilCapacityL: '4.5 – 5.5',
    oilFilter: 'OEM Geely', airFilter: 'OEM', fuelFilter: 'مدمج', cabinFilter: 'OEM',
    notes: 'مونجارو / شينغيو L',
  }),
  s({
    id: 'geely-tugella', brand: 'Geely', model: 'Tugella / Xingyue', years: '2020-2026', engine: '2.0T', region: 'chinese',
    oilViscosity: '0W-20 أو 5W-30', oilSpec: 'API SP', oilCapacityL: '4.5 – 5.0',
    oilFilter: 'OEM Geely', airFilter: 'OEM', fuelFilter: 'مدمج', cabinFilter: 'OEM',
  }),
  s({
    id: 'geely-okavango', brand: 'Geely', model: 'Okavango', years: '2020-2026', engine: '1.5T / 2.0', region: 'chinese',
    oilViscosity: '5W-30', oilSpec: 'API SP · ACEA C3', oilCapacityL: '4.0 – 4.8',
    oilFilter: 'OEM Geely · Mann', airFilter: 'OEM', fuelFilter: 'حسب المحرك', cabinFilter: 'OEM',
    notes: 'أوكافانغو — 7 مقاعد',
  }),
  s({
    id: 'geely-preface', brand: 'Geely', model: 'Preface', years: '2020-2026', engine: '2.0T', region: 'chinese',
    oilViscosity: '0W-20 أو 5W-30', oilSpec: 'API SP', oilCapacityL: '4.5 – 5.0',
    oilFilter: 'OEM Geely', airFilter: 'OEM', fuelFilter: 'مدمج', cabinFilter: 'OEM',
  }),
  s({
    id: 'geely-icon', brand: 'Geely', model: 'Icon', years: '2020-2025', engine: '1.5T', region: 'chinese',
    oilViscosity: '0W-20 أو 5W-30', oilSpec: 'API SP', oilCapacityL: '3.5 – 4.0',
    oilFilter: 'OEM Geely', airFilter: 'OEM', fuelFilter: 'مدمج', cabinFilter: 'OEM',
  }),
  s({
    id: 'geely-gx3-pro', brand: 'Geely', model: 'GX3 Pro', years: '2019-2025', engine: '1.5', region: 'chinese',
    oilViscosity: '5W-30', oilSpec: 'API SP · SN', oilCapacityL: '3.5 – 4.0',
    oilFilter: 'OEM Geely · Mann', airFilter: 'OEM', fuelFilter: 'مدمج', cabinFilter: 'OEM',
  }),
  s({
    id: 'geely-geometry-c', brand: 'Geely', model: 'Geometry C', years: '2020-2026', engine: 'Electric', region: 'chinese',
    oilViscosity: '— (كهربائية)', oilSpec: 'لا يوجد زيت محرك', oilCapacityL: '—', oilIntervalKm: 20000, oilIntervalMonths: 24,
    oilFilter: '—', airFilter: 'فلتر مقصورة فقط', fuelFilter: '—', cabinFilter: 'OEM Geometry · كربوني مفضّل',
    notes: 'Geometry C كهربائية — صيانة فلاتر المقصورة والتبريد فقط',
  }),
  s({
    id: 'geely-binrui', brand: 'Geely', model: 'Binrui', years: '2018-2025', engine: '1.4T / 1.5T', region: 'chinese',
    oilViscosity: '0W-20 أو 5W-30', oilSpec: 'API SP', oilCapacityL: '3.5 – 4.0',
    oilFilter: 'OEM Geely · Mann', airFilter: 'OEM', fuelFilter: 'مدمج', cabinFilter: 'OEM',
  }),
  s({
  ...
  s({
    id: 'toyota-vios-2023', brand: 'Toyota', model: 'Vios', years: '2018-2026', engine: '1.5 (2NR-FE / 1NR)', region: 'japanese',
    oilViscosity: '0W-20', oilSpec: 'API SP · ILSAC GF-6A', oilCapacityL: '3.4 – 3.7',
    oilFilter: 'Toyota 04152-YZZA1 · Mann W 610/6', oilFilterAlt: 'Bosch F026407094',
    airFilter: 'Toyota 17801-0Y050 · Mann', fuelFilter: 'مدمج في الخزان', cabinFilter: 'Toyota 87139-YZZ20 · Mann',
    notes: 'تويوتا فيوس 2023 — محرك 1.5 شائع في الأسواق العربية',
  }),
  s({
  ...
  s({
    id: 'hyundai-accent-2010-2026', brand: 'Hyundai', model: 'Accent / Verna', years: '2010-2026', engine: '1.4 / 1.6 Gamma / Smartstream', region: 'korean',
    oilViscosity: '5W-30 أو 0W-20', oilSpec: 'API SP · SN · ILSAC GF-5/GF-6A', oilCapacityL: '3.3 – 3.8',
    oilFilter: 'Hyundai 26300-35505 · 26300-35503 · Mann W 610/6', oilFilterAlt: 'Bosch F026407094',
    airFilter: 'Hyundai 28113-1R000 / حسب الجيل', fuelFilter: 'مدمج غالباً', cabinFilter: 'Hyundai 97133-1R000 · OEM',
    notes: 'هيونداي أكسنت / فيرنا 2010-2026 — للجيل الحديث غالباً 0W-20، للأقدم 5W-30',
  }),
  s({
