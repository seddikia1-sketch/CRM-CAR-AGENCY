  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', color: '#e8e8f0', paddingBottom: 72 }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <h1 style={{ fontSize: 'clamp(1.3rem, 4vw, 1.75rem)', fontWeight: 900, marginBottom: 8 }}>
            كتالوج السيارات الصينية
          </h1>
          <p style={{ color: '#8888a0', maxWidth: 480, lineHeight: 1.6, marginBottom: 12 }}>
            كل سيارة بإعلان جاهز: مواصفات، سعر، وزر للتفاصيل أو واتساب.
          </p>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '16px' }}>
        ...
        {tab === 'all' && !q && !brand && best.length > 0 && (
          <div style={{ marginBottom: 22 }}>
            <h2 style={{ fontWeight: 900, fontSize: '1.05rem', marginBottom: 10 }}>إعلانات مميزة</h2>
        ...
        <section style={{ marginTop: 28 }}>
          ...
          <div style={{ display: 'grid', gap: 10, gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))' }}>
            {[
              { n: 'كريم — سطيف', t: 'الإعلان واضح واتصلوا بي بسرعة.' },
              { n: 'سارة — الجزائر', t: 'طلبت كزائر بدون حساب — سهل من الهاتف.' },
              { n: 'يونس — وهران', t: 'واتساب بجانب كل سيارة ساعدني أسأل عن السعر.' },
            ].map((r) => (
              <div key={r.n} style={{
