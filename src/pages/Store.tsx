      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: 16, marginTop: 14, flexWrap: 'wrap', fontSize: '0.9rem' }}>
            ...
            <span>🏷️ {DEFAULT_OFFERS.filter((o) => o.active).length} عروض نشطة</span>
          </div>
        </div>
      </section>
              ...
              <div key={o.id} className="glass-card" style={{ padding: 18, position: 'relative', overflow: 'hidden' }}>
                ...
                <a
                  ...
                  style={{
                    ...
                    background: '#25D366', color: '#fff', padding: '10px', borderRadius: 10, fontWeight: 700,
                  }}
                >
          ...
          <div style={{ display: 'grid', gap: 14, gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))' }}>
            {filtered.length === 0 && (
              <div className="glass-card" style={{ padding: 24, gridColumn: '1 / -1', textAlign: 'center' }}>
                لا توجد سيارات مطابقة للبحث حالياً.
              </div>
            )}
            {filtered.map((c) => (
